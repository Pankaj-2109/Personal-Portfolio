...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          I am Pankaj Singh Bisht, a B.Tech Computer Science student
          at MAIT with a strong passion for Full Stack MERN
      ...
      "
        ...
        <div className="mt-8 flex flex-col [@media(min-width:540px)]:flex-row items-start md:items-center gap-4">
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-2 border border-white/30 text-white px-6 py-3 text-xs uppercase font-bold hover:bg-white hover:text-black rounded-full transition relative z-20"
          >
            Know More
          </motion.button>
        </div>
