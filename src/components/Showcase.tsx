...
const projects = [
  {
    tech: "React • Gemini AI • Clerk Auth  • Node.js",
    thumbnail: "/assets/lama-ai.png",
    github: "https://github.com/Pankaj-2109/LAMA-AI",
  },
  {
    tech: "React • Tailwind CSS • TypeScript • Claudinary",
    thumbnail: "/assets/ai-headshot-app.png",
    github: "https://github.com/Pankaj-2109/Ai-headshot-app",
  },
  {
    tech: "HTML5 • CSS3 • JavaScript • Responsive",
    thumbnail: "/assets/omnifood.png",
    github: "https://github.com/Pankaj-2109/OmniFood-Project",
  },
  {
    tech: "JavaScript • DOM • CSS • OOP",
    thumbnail: "/assets/bankist.png",
    github: "https://github.com/Pankaj-2109/Bankist-project-final",
  },
];
...
const certificates = [
  {
    ...
    tech: "Coursera",
    thumbnail: "/assets/google-ai-essentials.png",
    credentialUrl: "https://coursera.org/verify/specialization/S76I7FRD2MB2",
  },
  {
    title: "Google Prompting Essentials",
    tech: "Coursera",
    thumbnail: "/assets/google-prompting-essentials.png",
    credentialUrl: "https://coursera.org/verify/specialization/LTRAGEDLK3KY",
  },
  {
    title: "Introduction to Data Engineering and Bigdata",
    tech: "GUVI | HCL",
    thumbnail: "/assets/data-engineering-bigdata.png",
    credentialUrl: "https://www.guvi.in/certificate?id=N7182e35H8Wn915a84",
  },
];
...
function CertCard({ item }: { item: typeof certificates[0] }) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = url;
      const extension = item.thumbnail.split('.').pop() || 'png';
      link.download = `${item.title}.${extension}`;
